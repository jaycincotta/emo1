...
export const QuickTipsAutoplay: React.FC<QuickTipsProps> = ({ className, style }) => {
    return (
        <div className={className} style={style}>
            ...
            <div><strong>How</strong>: Press play to start. Close your eyes as the note plays. Then open your eyes to check the Solfege syllable + highlighted piano key. Continues automatically. Press Stop when you're done.</div>
